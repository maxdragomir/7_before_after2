  ...
  methods: {
    ...
    fixAnim () {
      ...
      setTimeout( () => {
        ...
        tl.to('.ba7-dice__img',.1,{y:-7500,ease:SteppedEase.config(25)})
          .to('.ba7-dice__img',.1,{y:0,ease:SteppedEase.config(25)});
    ...
    gamePlay() {
      ...
      tl1.set('.ba7-dice__img',{y:0})
        .to('.ba7-dice__img',.5,{y:-7500,ease:SteppedEase.config(25)})
        .to('.ba7-dice__img',.5,{y:0,ease:SteppedEase.config(25)});
  ...
  mounted: function mounted() {
    ...
    window.onload = () => {
      ...
      setTimeout( () => {
        ...
        tl2.fromTo('.ba7-dice__img',1.5,{y: 0,ease: SteppedEase.config(49)}, {y: -14700,ease: SteppedEase.config(49), repeat: -1, yoyo: true});
      }, 5000);
    };
  }
});
